...
import {deleteEducationDetailApi, listEducationDetail,} from "@libs/resources/api";
...
import EducationViewCompnent
    from "@modules/restricted/candidate/component/portfolio/portfolio-form/component/education/education-view.component";
import {
    EducationContext
} from "@modules/restricted/candidate/component/portfolio/portfolio-form/component/education/education.context";
...
const EducationComponent = () => {
    ...
    const handleOnHide = () => {
        setEducationDetail(null);
        setOpenAddEducationDialog(false)
    }
            ...
            <div className="w-full flex flex-col gap-2 py-3">
                <div className="flex items-center w-full gap-3">
                    ...
                    <UiDialog
                        ...
                        title={editIndex !== -1 ? "Update Education" : "Add Education"}
                        dialogWidth={"xl"}
                        dialogHeight={"xl"}
                    >
                        {getEducationForm()}
